...
import { isPreOrderProduct, isOutOfStockProduct } from "@/src/utils/productState";
      ...
      <div className="mx-auto flex max-w-md items-center gap-3">
        ...
        {outOfStock ? (
          <button
            ...
            disabled
            aria-disabled="true"
            className="inline-flex min-h-11 flex-1 cursor-not-allowed items-center justify-center rounded-bhor-sm bg-bhor-border px-4 text-bhor-button-mobile font-bhor-bold uppercase text-bhor-text-muted"
          >
            Out of Stock
          </button>
        ) : (
